  ...
  <div class="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div class="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <div class="relative mb-4">
        ...
        <input type="email" id="email" name="user_email" class="w-full bg-blue-200 rounded border border-blue-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-500 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
      </div>
      <div class="relative mb-4">
      ...
      <button type='submit' value="send" class="text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">Send</button>
      </div>
  </div>
</section>
