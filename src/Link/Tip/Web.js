...
<div className='pb-5 '>
<p className=' px-5 pb-5 text-white align-middle flex items-center justify-center text-justify font-alegreya text-[2.5vh]'>
...
Using the right technology, we will create specialized applications for your professional and private needs.
 ...
 digital presence. Allow us to assist you in growing along with us.
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <h1 class="font-hahmlet text-[1.5vh] text-center text-white">FRONT END</h1>
        ...
        <div class=" py-6 rounded-lg transform transition duration-500 hover:scale-110">
            ...
            <p class="leading-relaxed font-titillium text-[2vh] text-white">HTML</p>
          </div>
        </div>
        ...
        <div class="p-4 w-1/3 lg:w-1/6">
          ...
          <IoLogoCss3 class="text-blue-500 w-5 h-5 mb-1 inline-block"/>
            <p class="leading-relaxed font-titillium text-[2vh] text-white" >CSS</p>
          </div>
        </div>
        ...
        <div class="p-4 w-1/3 lg:w-1/6">
          <div class="py-6 rounded-lg transform transition duration-500 hover:scale-110">
           <DiJavascript class="text-yellow-500 w-5 h-5 mb-1 inline-block"/>
            <p class="leading-relaxed font-titillium text-[2vh] text-white">JavaScript</p>
          </div>
        </div>
        ...
        <div class="p-4 w-1/3 lg:w-1/6">
          <div class="py-6 rounded-lg transform transition duration-500 hover:scale-110">
           <GrReactjs class="text-cyan-500 w-5 h-5 mb-1 inline-block"/>
            <p class="leading-relaxed font-titillium text-[2vh] text-white">React JS</p>
          </div>
        </div>
        ...
        <div class="p-4 w-1/3 lg:w-1/6">
          ...
          <SiTailwindcss class="text-sky-500 w-5 h-5 mb-1 inline-block"/>
            <p class="leading-relaxed font-titillium text-[2vh] text-white">Tailwind CSS</p>
          </div>
        </div>
